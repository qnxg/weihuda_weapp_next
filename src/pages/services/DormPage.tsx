    ...
    <div className="page">
      ...
      <div className="summary-band surface">
        <div>
          ...
          <p className="summary-band__value">{electricity.data!.balance}</p>
          <p className="muted text-sm">{dorm.data!.room} 室</p>
        </div>
      ...
      <Section title="宿舍信息">
        <div className="surface list">
          <DataRow label="园区" value={dorm.data!.park} />
          <DataRow label="楼栋" value={dorm.data!.build} />
