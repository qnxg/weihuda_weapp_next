...
export const endpointCatalog = [
  ...
  {
    id: "course.custom.update",
    method: "PUT",
    path: "/course/custom/{customize_id}",
    auth: "required",
    consumer: "/schedule",
  },
  {
    id: "course.custom.delete",
    method: "DELETE",
    path: "/course/custom/{customize_id}",
    auth: "required",
    consumer: "/schedule",
  ...
  {
    id: "points.goods.exchanged",
    method: "GET",
    path: "/jifen/goods/exchanged",
    auth: "required",
    consumer: "/services/points",
  },
  {
  ...
  { id: "image.get", method: "GET", path: "/img/{id}", auth: "required", consumer: "/feedback" },
  {
    ...
    path: "/gym/grade",
    auth: "required",
    consumer: "/services/gym",
  },
  {
    id: "gym.appointment",
    method: "GET",
    path: "/gym/appointment",
    auth: "required",
    consumer: "/services/gym",
  },
  {
